...
(define-constant GCL_MENUNAME      -8)
(define-constant GCL_HBRBACKGROUND -10)
(define-constant GCL_HCURSOR       -12)
(define-constant GCL_HICON         -14)
(define-constant GCL_HMODULE       -16)
(define-constant GCL_CBWNDEXTRA    -18)
(define-constant GCL_CBCLSEXTRA    -20)
(define-constant GCL_WNDPROC       -24)
(define-constant GCL_STYLE         -26)
(define-constant GCW_ATOM          -32)
(define-constant GCL_HICONSM       -34)
