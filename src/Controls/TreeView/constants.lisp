...
(special-constant TVI_ROOT  (make-pointer (mask-field (byte 32 0) (- #x10000))))
(special-constant TVI_FIRST (make-pointer (mask-field (byte 32 0) (- #x0FFFF))))
(special-constant TVI_LAST  (make-pointer (mask-field (byte 32 0) (- #x0FFFE))))
(special-constant TVI_SORT  (make-pointer (mask-field (byte 32 0) (- #x0FFFD))))
